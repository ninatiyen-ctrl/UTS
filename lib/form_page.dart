...
Future<void> _pickImage() async {
  ...
  // Variabel dropdown, radio, dan checkbox
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            ...
                            onPressed: () {
                              ...
                              } else if (_statusMahasiswa == null) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content:
                                        Text('Pilih status mahasiswa terlebih dahulu!'),
